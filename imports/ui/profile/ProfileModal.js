...
import "/imports/ui/profile/styles.css";
...
export default ProfileModal = ({ isOpen, closeModal }) => {
	...
	return (
		<Modal isOpen={isOpen} onClose={closeModal} classes="profile-modal">
			<form className="form-container">
				...
				<button type="button" className="button primary" onClick={handleSubmit}>Update Profile</button>
			</form>
			<hr/>
			...
			<form className="form-container">
				...
				<button type="button" className="button primary" onClick={handlePasswordReset}>Reset Password</button>
			</form>
