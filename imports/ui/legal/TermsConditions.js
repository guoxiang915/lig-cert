		...
		<Fragment>
			...
			<section className="section legal-content">
				<div className="main-wrapper">
					...
					<p>References to the “Learning Platform” mean the educational platform containing videos, trainings, tools, and tips made available through the Web site.</p>
					...
					<p>References to a "Member" mean those registered and authorized enterprise Users of our Learning Platform.</p>
					<p>References to the “Terms” and/or “Agreement,” mean this, these Terms and Conditions, as set forth herein.</p>
					<p>References to “us,” “we,” “our,” and/or “SuperDataScience,” mean SuperDataScience Pty Ltd, and its parents, subsidiaries, and assigns.</p>
					<p>References to the “Web site” mean the Web site bearing the URL www.superdatascience.com.</p>
					<p>References to "you," and/or "User" mean a general user of the Web site and/or the Learning Platform, whether as a registered member, authorized enterprise user, email list subscriber, subscriber to our private Facebook group, or general Web site user.</p>
					...
					<p>Members agree and acknowledge that, due to the nature of the industry in which Members seek training, success and improvement in employment, profit or business growth is not guaranteed. Rather, success is dependent on Member’s own commitment to the learning the content provided, time and effort expended in relation to the training, educational background, prior work history, and ability to understand and implement lessons. In no event shall the provision of training be construed by a Member as a promise of profit, sales, revenues, or increased wealth or assets. To the extent any third-party income, sales or growth figures are mentioned, provided as a case study, or otherwise presented to Member, such information is anecdotal and passed on to SuperDataScience concerning the results achieved by the individual sharing the information. SuperDataScience has performed no independent verification of the statements made by those individuals. Such information, if provided, is provided for exemplar purposes only. In short, past performance and testimonials are not to be construed as an indication, promise, or projection of possible future employability or success. Member shall not assume that he or she has the potential to make such income or growth figures itself as a result of his or her participating in the Learning Platform.</p>

					<h5>2.2. Reliance on Training at Member’s Own Risk.</h5>
					<p>The training made available via the Learning Platform is intended as a self-help, motivation, personal-improvement, and informational tool. It is not intended to be a replacement for a mathematics, finance or business education, such as that received by a university, CPA, or MBA program. Training should not be relied upon or used as the sole basis for making decisions regarding business, finances, law, real estate, insurance, or any other specialized area without consulting primary, more accurate, more complete or more timely sources of information. Member is responsible for his or her own due diligence.</p>
					...
					<p>We reserve the right to refuse to provide access to the Web site and/or the Learning Platform for any reason at any time in our sole and exclusive discretion. We may, in our sole and exclusive discretion, limit or cancel a Member Account for any reason whatsoever, including but not limited to a breach or violation by the Member of any of the terms or provisions of the Terms and Conditions or any published SuperDataScience policy or procedure; a discredit of SuperDataScience by a User; misrepresentation of SuperDataScience by making claims contrary to SuperDataScience literature; ethical or legal violations that may cause SuperDataScience to suffer damages; or any other reason whatsoever, in the sole discretion of SuperDataScience.</p>
					<p>In the event that we make a change to or cancel an Account, we may attempt to notify you by contacting the e-mail and/or billing address/phone number provided at the time your Account was created, or, in the event of an authorized enterprise user, by contacting your corporate offices; however, the failure to do so shall not result in any liability, including liability for lost data deleted as a result of the Account termination. In the event we terminate your Account, you shall no longer be eligible to be a SuperDataScience Member at any time in the future, unless permission is granted to you, in writing, by us, in our sole and exclusive discretion.</p>
					<p>In addition, although the Web site and the Learning Platform are intended to be accessible worldwide, the Web site may not be available to all persons in all geographic locations or jurisdictions. SuperDataScience reserves the right to limit the availability of the Web site and/or the Learning Platform to any person, geographic area or jurisdiction it so desires, in our sole discretion, and to limit the quantities of any such product or service that it provides. Any offer for any product or service made via the Web site or the Learning Platform is void where prohibited by law.</p>
					...
					<p>For security purposes, we strongly advise you to keep your Account ID and password confidential and to change your Password if you think it may have been compromised. You are entirely responsible for maintaining the secrecy of this information. In addition, we recommend that you quit your entire browser application when you have completed your time on the Learning Platform. This is particularly important when you are using the Learning Platform at a public location, such as an Internet café, library, or workplace or on a public device. You agree to immediately notify SuperDataScience in the event of any security breach or unauthorized use of your Account ID, password, or any or all of your registration information. So that you can take advantage of the latest security technology, we recommend that you use the most recent version of your browser.</p>

					<h5>3.6. Termination.</h5>
					<p>You may terminate your Member Account at any time by writing to us at support@superdatascience.com. In no event shall a refund be due or owing should a Member elect to terminate his or her membership unless as provided for herein.</p>

					<h5>3.7. Meetups and Member Verification.</h5>
					<p>From time to time, Members may choose to meetup with other Members, in person, to further discuss their interest in data science. In doing so, Members agree and acknowledge that user authentication on the Internet is difficult, and SuperDataScience cannot, does not, and will not verify that each Member is who he or she claims to be. You assume all the risks inherent in the use of the Web site and the Learning Platform should you choose to meet up or communicate with other Members, including, but not limited to, the risks of bodily harm, property damage, harassment, fraud, the risk of dealing with strangers or persons underage and any other risks associated with meeting or communicating with someone who is unknown to you. You are solely and uniquely responsible for conducting your own due diligence on other Members and exercising common sense. In no event should a meet-up take place in a private space. SuperDataScience shall not be held liable for any losses, damages or claims associated with a meetup between Members.</p>
					...
					<h5>4.1. Subscription Fees.</h5>
					<p>Individual, non-enterprise Members wishing to subscribe to our premium services must pay a Subscription Fee in the amount set forth on the Web site at the time of purchase. We may increase these Subscription Fees from time to time, in our sole and exclusive discretion, where such changes shall take effect upon the next Billing Cycle (as defined in Section 4.4.) All Subscription Fees are expressed in U.S. Dollars ($USD.)</p>

					<h5>4.2. Trial Premium Subscription.</h5>
					<p>From time to time we may offer a month-long trial premium subscription either through a promotion, upon request, or some other means. Members who do not cancel such a trial subscription to our premium services prior to the expiration of the trial period shall be automatically billed the full, non-refundable monthly Subscription Fee on the same day of the month as the trial premium subscription was activated as set forth more fully in Section 4.4 hereof.</p>
					<p>Trial premium subscriptions may be cancelled at any time before 5 p.m. UTC+10 on the last day of the trial period by writing to us at support@superdatascience.com or by cancelling the membership in the Member’s Account settings.</p>

					<h5>4.3. Pre-Payment Discount.</h5>
					<p>In the event a Member elects to pre-pay the Subscription Fee on a quarterly or annual basis, Member may be entitled to a pre-payment discount as agreed to, in writing, between SuperDataScience and Member. Pre-payment discounts are given in our sole and exclusive discretion.</p>

					<h5>4.4. Automatic Billing.</h5>
					<p>Except for in the event of a trial premium subscription, all Subscription Fees as set forth herein shall be pre-paid, in full as per the selected billing cycle (which may be a month, quarter, or year, the “Billing Cycle,”) on the first (1st) day of the Billing Cycle, where the first (1st) day of the first (1st) Billing Cycle shall be the date upon which Member registers for a premium subscription. Member shall be billed on the same day thereafter at the beginning of each Billing Cycle.</p>

					<h5>4.5. Form of Payment.</h5>
					<p>Payment shall be made automatically via our payment processor, Stripe, by automatic debit of the major credit or debit card provided by Member upon Account registration or as later updated by Member. Payment through PayPal or other payment methods may be available upon request, where permission for the same is granted in our sole and exclusive discretion.</p>

					<h5>4.6. Limited Money-Back Guarantee.</h5>
					<p>SuperDataScience believes in its Learning Platform, and, therefore, is pleased to offer a limited guarantee to each of its Members. Per this guarantee, a Member may cancel his or her membership in the Learning Platform for any or no reason whatsoever, for a limited refund, within thirty (30) calendar days of the date of membership activation. In the event Member has subscribed to our premium services, Member shall be entitled to a full refund of any Subscription Fee paid (whether a trial subscription fee or a full subscription fee.) Such refund shall be limited to the actual amount paid by Member. Any and all requests for a refund under this Section 4.6 must be made, in writing, to support@superdatascience.com or through the refund link in a Member Account no later than 5 p.m. UTC+10 on the thirtieth (30th) day of Account registration. Requests for refund made thereafter shall not be granted.</p>

					<h5>4.7. Refunds.</h5>
					<p>Due to the electronic nature of the services that we provide, in no event other than material breach of these Terms by SuperDataScience or as provided in Section 4.6, shall a refund be granted, in whole or in part, for any reason or no reason whatsoever, including but not limited to Member’s cancellation of a premium subscription prior the end of the Billing Cycle and/or Member’s failure to utilize the Web site and/or Learning Platform.</p>

					<h2>Section V: Interactive areas; Submissions</h2>
					<h5>5.1. Account Guidelines.</h5>
					<p>The Web site, Learning Platform, and our private Facebook group, together with other private and/or Member-only mediums may contain the ability to communicate with other members, share via social media, participate in any comments sections and discussion forums, social media outlets, sales channels, and/or other interactive features, (collectively “Interactive Areas,”) in which Users may communicate. By participating in Interactive Areas, you agree and acknowledge that you:</p>
					...
					<p>Shall not to use language that abuses or discriminates on the basis of race, religion, nationality, gender, sexual preference, age, region, disability, etc. Hate speech of any kind is grounds for immediate and permanent suspension of access to the Interactive Area and Member Account, if applicable; and</p>
					<p>Shall not personally attack another Users. Personal attacks are a direct violation of these Terms and Conditions and are grounds for immediate and permanent suspension of access the Interactive Area and Member Account, if applicable; and</p>
					...
					<p>SuperDataScience is not liable for Submissions provided by any Users or third parties. Such Submissions do not represent the views of SuperDataScience, its subsidiaries, or its partners.</p>

					<h5>5.4. Member Communications.</h5>
					<p>SuperDataScience does not screen communications in advance and is not responsible for screening or monitoring material and content posted by Users to Interactive Areas. If a User notifies SuperDataScience of communications, which allegedly do not conform to these Terms, SuperDataScience may investigate the allegation to determine, in good faith and its sole discretion, whether to remove or to request the removal of the communication. SuperDataScience has no liability or responsibility to users for performance or nonperformance of such activities.</p>
					...
					<p>Except as provided, you may not copy, reproduce, publish, transmit, transfer, sell, rent, modify, create derivative works from, distribute, repost, perform, display, or in any way commercially exploit the Materials, nor may you infringe upon any of the copyrights or other intellectual property rights contained in the Materials. You may not remove or alter, nor cause to be removed or altered, any copyright, trademark, or other proprietary notices or visual marks and logos from the Materials. You may not register any domain names that may confuse or contain any portion of the SuperDataScience trade names or marks.</p>
					<p>You may make a single print copy of any Materials provided by us on the Web site for personal, non-commercial use only, provided that you do not remove nor cause to be removed any copyright, trademarks, or other proprietary notices or visual marks or logos from the Materials. You may not archive or retain any of the Materials accessed on the Web site or Learning Platform without our express written permission. All requests for archiving, republication or retention of any part of the Materials must be in writing to us and must clearly state the purpose and manner in which the Material will be used. Requests for permission to archive, retain, or republish any part of the Materials may be submitted to support@superdatascience.com.</p>
					<p>SuperDataScience makes no claims that the Materials are appropriate or may be downloaded outside Australian. Access to the Materials may not be legal by certain persons or in certain countries. If you access the Web site from outside Australian, you do so at your own risk and are responsible for compliance with the laws of your jurisdiction, including those relating to privacy.</p>
					...
					<p>In the event you provide a testimonial, you hereby assign, transfer and grant to SuperDataScience, its successors, assignees, licensees, sponsors, any television networks, and all other commercial exhibitors the exclusive, irrevocable right and license to utilize such testimonial and providing User’s name, photograph, likeness, and occupation, in advertising and promoting SuperDataScience and in all media for social media, advertising, trade, and any other lawful purposes. You understand that neither SuperDataScience nor any third party is under any obligation to exercise any of the foregoing rights, licenses and privileges.  You waive any right to inspect or approve any materials related thereto or to claim any royalty therefor.</p>
					...
					<p>(F) SuperDataScience'S LIABILITY, AND (AS APPLICABLE) THE LIABILITY OF our AFFILIATES AND ANY RESPECTIVE DIRECTORS, OFFICERS, EMPLOYEES, CONTRACTORS, PARENTS, SUBSIDIARIES, AGENTS, THIRD PARTY CONTENT PROVIDERS AND LICENSORS TO YOU OR ANY THIRD PARTIES IN ANY CIRCUMSTANCE IS LIMITED TO THE GREATER OF (A) THE AMOUNT OF FEES YOU PAY TO SUPERDATASCIENCE IN THE TWELVE (12) MONTHS PRIOR TO THE ACTION GIVING RISE TO LIABILITY, OR (B) ONE HUNDRED U.S. DOLLARS ($100.00.)</p>
					...
					<p>Should you have any questions, comments or concerns regarding the Web site or Learning Platform, customer service may be contacted at any time via email at support@superdatascience.com. We strive to return all customer service inquires within forty-eight (48) business hours, between 8 a.m. and 5 p.m. UTC+10.</p>
