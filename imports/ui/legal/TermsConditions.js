		...
		<Fragment>
			...
			<section className="section legal-content">
				<div className="main-wrapper">
					...
					<h5>2.2. Reliance on Training, Testimonials at Student's Own Risk.</h5>
					<p>The training made available via the Learning Platform is intended as a self-help, motivation, personal-improvement, and informational tool. It is not intended to be a replacement for a mathematics, finance or business education, such as that received by a university, CPA, or MBA program.</p>
					<p>Testimonials, endorsements, or reviews of former or current students are freely given from said student's own personal experience. To the extent any third-party income, sales or growth figures are mentioned, provided as a case study, or otherwise presented, such information is anecdotal. We have performed no independent verification of the statements made by those individuals. In short, past performance and testimonials are not to be construed as an indication, promise, or projection of possible future success.</p>
					<p>Neither the training or any testimonials should be relied upon or used as the sole basis for making decisions regarding business, finances, law, real estate, insurance, or any other specialized area without consulting primary, more accurate, more complete or more timely sources of information. Students are responsible for their own due diligence.</p>
